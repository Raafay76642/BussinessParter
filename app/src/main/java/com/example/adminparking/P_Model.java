...
public class P_Model {
    ...
    public P_Model(String city_name, String p_name, String longi, String lati, String address, String p_space,String uid) {
    ...
    public P_Model(String city_name, String p_name, String longi, String lati, String address,String uid) {
        this.city_name = city_name;
        P_name = p_name;
        Longi = longi;
        Lati = lati;
