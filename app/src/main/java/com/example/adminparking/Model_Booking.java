...
public class Model_Booking {
    ...
    String coname;
    String pname;
    String NotificationBooking;

    public String getNotificationBooking() {
        return NotificationBooking;
    }

    public void setNotificationBooking(String notificationBooking) {
        NotificationBooking = notificationBooking;
    }

    public Model_Booking(String notificationBooking) {
        NotificationBooking = notificationBooking;
    }
